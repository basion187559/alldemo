...
public final class Monster extends Table {
  ...
  public cn.basion.bean.Vec3 pos() { return pos(new cn.basion.bean.Vec3()); }
  public cn.basion.bean.Vec3 pos(cn.basion.bean.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public cn.basion.bean.Weapon weapons(int j) { return weapons(new cn.basion.bean.Weapon(), j); }
  public cn.basion.bean.Weapon weapons(cn.basion.bean.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public cn.basion.bean.Weapon.Vector weaponsVector() { return weaponsVector(new cn.basion.bean.Weapon.Vector()); }
  public cn.basion.bean.Weapon.Vector weaponsVector(cn.basion.bean.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public cn.basion.bean.Vec3 path(int j) { return path(new cn.basion.bean.Vec3(), j); }
  public cn.basion.bean.Vec3 path(cn.basion.bean.Vec3 obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int pathLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public cn.basion.bean.Vec3.Vector pathVector() { return pathVector(new cn.basion.bean.Vec3.Vector()); }
  public cn.basion.bean.Vec3.Vector pathVector(cn.basion.bean.Vec3.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
